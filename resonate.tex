...
\author{Ting Wang}
\affil{Department of Computer, National University of Defense Technology, Changsha, China}
...
\vspace{-4em}\caption{Plate illustration of the user-level LDA model.}
\label{fig:graph2}
\end{figure}
